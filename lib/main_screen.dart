...
import 'package:voice_chatgpt/gpt_conversation.dart';
...
class _MainScreenState extends State<MainScreen>
  ...
  List<Map<String, dynamic>> gpt_conver = [];
    ...
    await dbHelper.getChatMessage().then((value) async {
      for (int i = 0; i < value.length; i++) {
        ...
        Map<String, dynamic> conver = {
          'role': value[i]["type"] == 1 ? "user" : "assistant",
          'content': value[i]["content"]
        };
        gpt_conver.add(conver);
        setState(() {
              ...
              child: GestureDetector(
                ...
                onTapUp: (details) async {
                  ...
                  if (text != "") {
                    ...
                    var msg = await ApiService.sendMessage(text, gpt_conver);
            ...
            flexibleSpace: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: NetworkImage(
                      'https://i.pinimg.com/564x/90/fa/26/90fa26f9df8f5b6d218e68dd81ff3e83.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
        ...
        body: SingleChildScrollView(
          ...
          child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: NetworkImage(
                      'https://i.pinimg.com/564x/57/0a/1a/570a1ae56c87f385a525ba43cf5abf87.jpg'),
                ...
                Container(
                  ...
                  children: [
                    ...
                    Switch(
                      ...
                      inactiveTrackColor: Color(0xfffa9abaa),
    ...
    if (type == 1) {
      return Row(
        children: [
          ClipOval(
            child: Image.network(
              "https://z-p4-instagram.fsgn5-8.fna.fbcdn.net/v/t51.2885-19/278753174_724182805623321_3394183371636473540_n.jpg?stp=dst-jpg_s150x150&_nc_ht=z-p4-instagram.fsgn5-8.fna.fbcdn.net&_nc_cat=109&_nc_ohc=jt42ZMLE8VUAX-9uJlN&edm=ACWDqb8BAAAA&ccb=7-5&oh=00_AfCU3PoRDUx-bKfGxa5_PHhM6API0noKKws52N1Syj7HcQ&oe=64362210&_nc_sid=1527a3",
              width: 40,
              height: 40,
              fit: BoxFit.cover,
            ),
        ...
        children: [
          ...
          Column(
            children: [
              ClipOval(
                child: Image.network(
                  "https://i.pinimg.com/564x/16/ba/d6/16bad6ea9bb12c39a844e241414f4481.jpg",
                  width: 40,
                  height: 40,
                  fit: BoxFit.cover,
                ),
